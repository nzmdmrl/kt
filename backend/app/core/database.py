...
async def init_models() -> None:
    ...
    from app.models import user, bot, daily_score, league_award, game_setting, sound_asset, word, notification, match_history, solo, arena_history, friendship, custom_arena, collected_word  # noqa: F401
