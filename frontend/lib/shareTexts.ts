...
const FALLBACK: ShareTexts = {
  ...
  lines: {
    ...
    "room:win": ["🎪 Arkadaşlarla özel odada kelime düellosu — kazanan benim!"],
    "room:podium": ["🎪 Özel odada kıl payı ikinci oldum!"],
    "room:loss": ["🎪 Arkadaşlarla özel odada kelime düellosu yaptık!"],
